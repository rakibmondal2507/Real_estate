...
function Navbar() {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
         <div className='conatainer mx-auto flex justify-between items-center py-4 px-6 md:px20 lg:px-32 bg-transparent'>
    ...
    <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all `}>
      <div className='flex justify-end p-6 cursor-pointer'><img src={assets.cross_icon} className='w-6' alt="" /></div>
